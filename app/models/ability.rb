class Ability
  ...
  def initialize(user)
    ...
    when 'teacher'
        can [:update_password], User, :id=>user.id
        can [:search, :profile, :download_personal_record_file, :matching_date_and_user, :search_group, :get_group_id_number, :search_group_by_group_id, :search_group_by_year, :view_group], Person
